...
git add README.md docs .gitignore kw_mlops/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[kw_mlops/databricks.yml](../kw_mlops/databricks.yml) file.
...
Follow the instructions in [kw_mlops/resources/README.md](../kw_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../kw_mlops/resources/README.md)  to propose, test, and deploy
