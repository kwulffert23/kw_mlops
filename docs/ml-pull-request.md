...
Opening a pull request will trigger a[workflow](../.github/workflows/kw_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/kw_mlops/kw_mlops-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/kw_mlops/kw_mlops-model)
. 
